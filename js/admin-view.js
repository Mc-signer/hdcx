...
function dotsOption(element) {
    ...
    if (r == true) {
        ...
        $(element).parent().parent().remove();
          var father = $(element).parent().parent(); //删除选项的ID
        ...
        if ($(".main-right-match-now .jiange .main-right-match-content-detail").length == 0) 
        {
            $(".main-right-match-now .jiange .none").css("display", "block");
